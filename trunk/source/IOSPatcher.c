...
s32 Install_patched_IOS(u32 iosnr, u32 iosrevision, bool es_trucha_patch, bool es_identify_patch, bool nand_patch, bool version_patch, u32 location, u32 newrevision, bool free)
{
	int ret;
	...
	if (es_trucha_patch || es_identify_patch || nand_patch)
	{
		...
		if (trucha > 0 || identify > 0 || nand > 0 || version > 0)
		{
